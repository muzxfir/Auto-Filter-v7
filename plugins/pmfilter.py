...
async def pm_text(bot, message):
    ...
    text=(
        f"Hey {user} 😍\n\n"
        "You can search for movies only in our Movie Group.\n"
        "You are not allowed to search for movies in the Direct Bot.\n\n"
        "Please join our movie group by clicking the 'Request Here' button below and search for your favorite movies there 👇\n\n"
        "आप केवल हमारे Movie Group पर ही मूवी सर्च कर सकते हो।\n"
        "आपको Direct Bot पर मूवी सर्च करने की अनुमति नहीं है।\n"
        "कृपया नीचे दिए गए 'Request Here' बटन पर क्लिक करके हमारे Movie Group को जॉइन करें और वहां मूवी सर्च करें।"
    ),
    reply_markup=InlineKeyboardMarkup([
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('ᴛɢᴇʙᴏᴛᴢ 📜', url='https://github.com'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
